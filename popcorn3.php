...
<head>
    ...
    <meta charset = "utf-8" />
    <style type = "text/css"> td, th, table {border: thin solid black;} </style>
    <form action = "popcorn-practice/PHP 7.4/php.exe"</form>
    </head>
<body>
    <?php
 ...
 // Return the results to the browser in a table
    ...
    <?php print ("$name <br /> $street <br /> $city <br />");
    ?>
        <p /> <p />
        <table>
        ...
        <td> $3.00 </td>
        <td> <?php print ("$unpop"); ?>
        </td> <td> <?php printf ("$%4.2f", $unpop_cost); ?>
        </td>
        </tr>
        <tr>
        <td> Caramel Popcorn </td>
        <td> $3.50 </td>
        <td> <?php print ("$caramel"); ?>
        </td>
        ...
        <td> $5.00 </td> <td> <?php print ("$toffeynut"); ?>
        </td> <td> <?php printf ("$%4.2f", $toffeynut_cost); ?>
        </td>
        </tr>
        </table>
        <p /> <p />
